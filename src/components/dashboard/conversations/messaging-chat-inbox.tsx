    ...
    return (
      <div ref={ref} {...props}>
        <div className="flex h-full w-full flex-col overflow-hidden">
          ...
          <div className="mb-6 flex flex-none flex-col gap-4 px-3 sm:px-6">
            <div>
          ...
          <ScrollShadow className="flex flex-1 min-h-0 flex-col gap-6 overflow-y-auto px-3">
            <Listbox
              classNames={{
                base: "p-0",
              }}
                ...
                >
                  <div className="flex items-center gap-2 py-1">
                    ...
                    <div className="ml-2 min-w-0 flex-1">
                      ...
                      <div className="text-small text-default-500 truncate">{item.message}</div>
                    </div>
                  </div>
                </ListboxItem>
              )}
