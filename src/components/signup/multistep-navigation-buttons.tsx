...
>(({className, onBack, onNext, backButtonProps, nextButtonProps, isFirstStep, ...props}, ref) => (
  <div
    ref={ref}
    className={cn(
  ...
  >
    {isFirstStep ? (
      <Button
        as={Link}
        href="/"
        className="rounded-medium border-default-200 text-medium text-default-500 font-medium lg:hidden"
        variant="bordered"
      >
