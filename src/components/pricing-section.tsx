...
export default function PricingSection() {
  ...
  return (
    <section
      id="pricing"
      className="dark bg-black flex flex-col items-center rounded-2xl px-6 py-24 md:rounded-3xl md:py-32"
    >
      <div className="flex max-w-4xl flex-col items-center">
        <div className="flex max-w-xl flex-col text-center">
          <h2 className="text-primary font-medium">Pricing</h2>
          <h1 className="text-4xl font-medium tracking-tight text-white">Get unlimited access.</h1>
          <Spacer y={4} />
          ...
          {tiers.map((tier) => (
            <Card
              ...
              className={cn("relative p-3", {
                "border-primary shadow-primary/20 border-2 shadow-2xl": tier.mostPopular,
